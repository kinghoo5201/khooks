...
export default function useUniqueAsync(
  fn /** 防抖时间配置，只有初始化就确定，不配置无防抖 */,
  debounceTime,
) {
  var reqId = useRef();
  ...
  var asyncFn = useCallback(
    (function () {
      var fnBody = /*#__PURE__*/ (function () {
                ...
                while (1)
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      _context.next = 6;
                      return $fn.current.apply($fn, _args);
                    case 6:
                      res = _context.sent;
                      if (!(reqId.current !== requestId || isunmount.current)) {
                        _context.next = 9;
                        break;
                      }
